...
pkgdata_SCRIPTS+=bs_mirrorfull findfileconflicts publish_distro generate-release-packages verify-build-and-generatelists gocd/verify-repo-built-successful.py
